...
var KISS07 = __webpack_require__(6);

var Kybos = __webpack_require__(7);

var LFib = __webpack_require__(8);

var LFIB4 = __webpack_require__(9);

var MRG32k3a = __webpack_require__(10);

var Xorshift03 = __webpack_require__(11);
...
var PRNGs = __webpack_require__(2);
...
function passfather(options) {
  ...
  var seed = opts.seed || isBrowser() ? shuffle(DEFAULT_BROWSER_SEED) : shuffle(DEFAULT_NODE_SEED);
...
// From http://baagoe.com/en/RandomMusings/javascript/
var Mash = __webpack_require__(0);
...
var os = isBrowser() ? null : eval('require("os")');
/**
 * Default seed for prng
 * @const
 */

var DEFAULT_NODE_SEED = !isBrowser() ? compact([].concat(Date.now(), process.memoryUsage ? [process.memoryUsage().heapTotal, process.memoryUsage().heapUsed] : null, process.env ? [process.arch, process.platform, os.cpus().length, os.totalmem()] : null)) : null;
/**
 * Default seed for prng
 * @const
 */

var DEFAULT_BROWSER_SEED = isBrowser() ? compact([].concat(Date.now(), performance && performance.memory ? [performance.memory.totalJSHeapSize, performance.memory.usedJSHeapSize] : null, navigator ? [navigator.userAgent, navigator.appVersion, navigator.hardwareConcurrency, navigator.deviceMemory] : null)) : null;
module.exports = {
  DEFAULT_NODE_SEED,
